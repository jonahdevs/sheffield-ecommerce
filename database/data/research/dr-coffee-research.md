...
| IMG/COF/00099 | F11 (standard) | `...__f11-std-front/left/right-black.jpg`, `...-silver.jpg` (6 files) + `...__f11-std-render-black.png`, `...-render-silver.png` | **Standard 2 L F11 - no side tank, 300 mm deep.** Kept as angle references only; do **not** use as the F11 Big's product photo |
| IMG/COF/00096 | Minibar | `IMG-COF-00096__minibar-s2-front.jpg`, `-s2-left.jpg`, `-s2-right.jpg`, `-s2-render.png` | **S2** = two wands (steam + hot water); matches our catalogue photo |
