...
**17 files.** Two source types, both pulled with `curl`:
...
| SKU | File | Source | Content |
|---|---|---|---|
| IMG/COF/00116 | `IMG-COF-00116__VCT-1000-official-front.png` (788×903) | Antunes VCT spec sheet | ✅ VCT-1000, plain, **dial thermostat** visible. Best storefront candidate |
| IMG/COF/00116 | `IMG-COF-00116__VCT-1000-official-butterwheel-bunfeeder.png` (765×1123) | Antunes VCT spec sheet | ✅ VCT-1000 fitted with motorised butter wheel + angled bun feeder (accessories, not standard) |
| IMG/COF/00116 | `IMG-COF-00116__VCT-1000-jestic.jpg` (500×500) | Jestic | ✅ VCT-1000, dial thermostat, buns loaded. Lower res |
| IMG/COF/00127 | `IMG-COF-00127__GST-1V-official-front.png` (799×897) | Antunes GST-1V sales sheet | ✅ GST-1V, 3-lane top hopper, blue rotary control |
| IMG/COF/00127 | `IMG-COF-00127__GST-1V-left-jestic.jpg` (1420×1504) | Jestic | ✅ GST-1V left three-quarter, blue rotary control |
| IMG/COF/00127 | `IMG-COF-00127__GST-1V-right-jestic.png` (1486×1504) | Jestic | ✅ GST-1V right three-quarter — **digital control panel** version (see note below). Highest-resolution image in the set |
| IMG/COF/00127 | `IMG-COF-00127__GST-1V-official-belt-detail.png` (857×725) | Antunes GST-1V sales sheet | ✅ GST-1V with front panel removed, blue dual belts exposed. **Not a dimension drawing** despite looking technical — it's a photo |
| IMG/COF/00125 | `IMG-COF-00125__AQ-RO-HC-official-front.png` (730×924) | Antunes AQ-RO HC sales sheet | ✅ AQ-RO High Capacity — membrane vessel, feed pump, gauge, two prefilter bowls on a wall panel. Only product shot found |
| IMG/COF/00130 | `IMG-COF-00130__AQ-RO-600-official-front.png` (932×1067) | Antunes AQ-RO sales sheet | ✅ AQ-RO with digital colour display + pressure gauge + two prefilters |
| IMG/COF/00131 | `IMG-COF-00131__VZN-500-series-official-vertical.png` (386×826) | Antunes VZN 500-series sales sheet | ⚠ VZN vertical system — the 500-series sheet does not label which model each render is, so this is **series-representative, not confirmed 511V**. Small (386 px wide) |
| IMG/COF/00131 | `IMG-COF-00131__VZN-511V-reseller.jpg` (1000×1000) | kitchenrestock CDN | ✅ VZN-511V listing photo — vertical UF vessel, blue tank, single white carbon cartridge. Matches the official "vertical system with one carbon cartridge" description. Largest available but only 48 KB |
| IMG/COF/00132 | `IMG-COF-00132__HRS-200-official-cartridge.png` (695×1866) | Antunes HRS-200 sales sheet | ✅ HRS-200 cartridge with blue head. Tall aspect ratio (1:2.7) — will need padding for a square product tile |
| IMG/COF/00133 | `IMG-COF-00133__DAC-5-official-tube.png` (326×585) | Antunes DAC sales sheet | ✅ Single DAC tube with black collar + a loose collar alongside. Closest official DAC-5 shot |
| IMG/COF/00133 | `IMG-COF-00133__DAC-5-official-collar-detail.png` (779×590) | Antunes DAC sales sheet | ✅ Close-up of the self-elevating collar mechanism |
| IMG/COF/00133 | `IMG-COF-00133__DAC-5-jestic-single-tube.jpg` (500×500) | Jestic | ✅ **Best DAC-5 storefront candidate** — clean white background, single tube, stainless collar, cup loaded. Only 9.7 KB though |
| IMG/COF/00133 | `IMG-COF-00133__DACS-30-official-cabinet-NOT-DAC-5.png` (340×727) | Antunes DAC sales sheet | ❌ **wrong model** — this is the DACS-30 three-tube stainless cabinet |
| IMG/COF/00133 | `IMG-COF-00133__LS-series-cabinet-NOT-DAC-5.jpg` (500×500) | Jestic | ❌ **wrong model** — LS-series cabinet with lid and straw compartments |
