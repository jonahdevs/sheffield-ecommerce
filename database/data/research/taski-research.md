...
**This file supersedes the archived research below.** The archived file remains the fuller
...
§9 of the archived research below.3 lists Solenis as "403 to automated access", and §12 records its
...
301 to `products.solenis.com` - every `eshop.diversey.*` URL in the archived research below is dead.
...
5. Lifecycle questions from the archived research below §5.1 remain unanswered.
