...
**6 files total.** All clear the 800 px minimum-long-edge rule.

| SKU | File | Px / size | Source | Notes |
|---|---|---|---|---|
| IMG/HOT/00186 | `IMG-HOT-00186__SE40-0CB-official-front.jpg` | **1100×1422**, 82 KB | https://baronprofessional.com/online/82702-thickbox_default/electric-salamander-with-movable-radiant-plate-single-phase-2-kw.jpg | **Primary candidate.** Official Baron render, plain stainless control panel, single knob (correct for the single-phase 2 kW SE40) |
| IMG/HOT/00186 | `IMG-HOT-00186__SE40-0CB-datasheet-dimension-drawing.jpg` | **1100×777**, 124 KB | embedded object in https://storage.onpage.it/4c45b5575c7c6bc3e3cb6eb06db3b1f965dcde25/SE40-0CB_en.pdf (page 3) | **Reference, not a product photo.** The dimensioned installation drawing behind §3.2/§3.3 — carries the 548 overall depth, 496 height and 95–240 grid range. White-on-black as printed. Extracted losslessly with `fitz` |
| IMG/HOT/00186 | `IMG-HOT-00186__SE40-0CB-tecnoinox-216041.jpg` | 1920×1419, 106 KB | https://www.tecnoinox.it/app/uploads/2024/06/IMG-216041_20240511_181928.jpg | **Do not use as-is.** Highest resolution of the set, but the control panel is a black **Tecnoinox-branded** fascia (§3.4) — visibly a different brand's unit |
| IMG/HOT/00186 | `IMG-HOT-00186__SE40-0CB-accessory-9003-wall-supports.jpg` | 1100×1422, 58 KB | https://baronprofessional.com/online/95398-thickbox_default/stainless-steel-supports-for-wall-application-depth-8-cm-1-pair.jpg | Accessory **9003** wall-mount supports — a gallery extra, not the product |
| IMG/HOT/00189 | `IMG-HOT-00189__DI7FRE415-official-front.jpg` | **1100×1422**, 48 KB | https://baronprofessional.com/online/88839-thickbox_default/electric-fryer-1-bowl-15-l.jpg | **Primary candidate.** Official Baron render; clearly shows the drop-in flange, below-counter body and drain tap (the §4.1 "Table Top" evidence) |
| IMG/HOT/00189 | `IMG-HOT-00189__DI7FRE415-accessory-CR0599830-basket-kit.jpg` | 1100×1422, 91 KB | https://baronprofessional.com/online/95390-thickbox_default/kit-2-1-2-baskets-for-drop-in-fryer-lt-10-15.jpg | Accessory **CR0599830** half-basket kit — gallery extra, not the product |

### 7.1 Re-sourcing pass (July 2026) — two reseller thumbnails deleted, ceiling proved

The set originally carried two sub-800 px reseller shots of the SE40/0CB. **Both were
deleted rather than re-sourced, because both are the *same Baron render* already held at
1100 × 1422** — they were downscaled copies, not different photographs:

- `IMG-HOT-00186__SE40-0CB-reseller-heo.webp` (was 500×500). The URL was an OpenCart
  **cache** path (`/image/cache/catalog/product/SE40-500x500.webp`). Stripping the cache
  segment to `/image/catalog/product/SE40.webp` returns the uncached original — but it is
  only **591 × 591**, still under the bar. `-1500x1500` and `-2000x2000` cache sizes 404.
  That host's ceiling is 591 px.
- `IMG-HOT-00186__SE40-0CB-reseller-sck.jpg` (was 300×268). The
  `uploads.prod01.sydney.platformos.com` asset exists in exactly one size; `_large`,
  `-large`, `@2x`, `_full` and `.png` variants all 403. That host's ceiling is 300 px.

**Baron's own ceiling is the 1100 × 1422 already held.** Every PrestaShop image type was
probed on the SE40 render (id 82702): `thickbox_default` **1100×1422** (largest),
`large_default` 1000×1257, `home_default` 700×880, `medium_default` 452×568, and
`original` 404s.

**PDF extraction was run as instructed** (`fitz`/PyMuPDF, embedded objects, not page
rasterisation) on both official `storage.onpage.it` datasheets. It did **not** beat the web
render: the SE40 sheet's embedded product photo is **800 × 860** — the identical render,
more tightly cropped, so fewer pixels on the product than the 1100 × 1422 file. Its real
prize was the **1100 × 777 dimension drawing** now added above, which fills the gap this
section previously noted ("no dimension drawings in this set"). Other embedded objects are
brand furniture (800×358 header, 468×468 logo block).
