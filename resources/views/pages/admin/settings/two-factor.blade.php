...
<section class="w-full">
    ...
    <x-pages::admin.settings.layout :heading="__('Two Factor Authentication')" :subheading="__('Manage your two-factor authentication settings')">
            ...
            <div class="flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
                @if ($twoFactorEnabled)
                    <div class="space-y-4">
                        ...
                        <livewire:pages::admin.settings.two-factor.recovery-codes :$requiresConfirmation />
