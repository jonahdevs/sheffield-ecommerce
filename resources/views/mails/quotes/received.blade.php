          ...
          <div style="background-color: #fffffe; padding: 20px 36px 0;">
            ...
            <table cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
              ...
              <tr>
                ...
                <td style="border-bottom: 1px solid; border-color: #f1f5f9; padding-top: 12px; padding-bottom: 12px; padding-left: 12px; text-align: right; vertical-align: middle; font-size: 13px; font-weight: 600; white-space: nowrap; color: #475569;">{{ $item->quantity }}</td>
              </tr>
              @endforeach
            </table>
          </div>
