        ...
        <div style="overflow: hidden; background-color: #fffffe;">
          ...
          <div style="background-color: #2f4196; padding: 24px 36px 32px;">
            ...
            <table cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
              <tr>
                <td style="padding-top: 24px; vertical-align: middle;">
                  ...
                  <p class="text-white-70" style="margin: 4px 0 0; font-size: 13px; color: rgba(255, 255, 254, .7);">Order {{ $order->order_number }} - here's the latest.</p>
                </td>
            ...
            <p class="text-white-80" style="margin: 0; font-size: 13.5px; line-height: 21px; color: rgba(255, 255, 254, .8);">
              Your order is now
              <span style="font-weight: 700; color: #fffffe;">{{ $newStatus->label() }}</span>
          ...
          <div style="background-color: #fffffe; padding: 28px 36px 4px;">
            @php $processingActive = in_array($newStatus->value, ['processing', 'out_for_delivery', 'completed']); $outActive = in_array($newStatus->value, ['out_for_delivery', 'completed']); $completedActive = $newStatus->value === 'completed'; $orderUrl = route('account.orders.show', $order); @endphp
            <table cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; table-layout: fixed;">
              <tr>
                <td style="width: 7.5%;"></td>
                <td style="width: 10%; vertical-align: middle;"><div style="background-color: #2f4196; margin-left: auto; margin-right: auto; height: 36px; width: 36px; border-radius: 9999px; text-align: center; font-size: 14px; line-height: 20px; line-height: 36px; font-weight: 700; color: #fffffe;">✓</div></td>
                <td style="width: 15%; vertical-align: middle;">
                  @if ($processingActive)
                  <div style="background-color: #2f4196; height: 3px; width: 100%;"></div>
                  @else
                  <div style="height: 3px; width: 100%; background-color: #e2e8f0;"></div>
                  @endif
                </td>
                <td style="width: 10%; vertical-align: middle;">
                  @if ($processingActive)
                  <div style="background-color: #2f4196; margin-left: auto; margin-right: auto; height: 36px; width: 36px; border-radius: 9999px; text-align: center; font-size: 14px; line-height: 20px; line-height: 36px; font-weight: 700; color: #fffffe;">✓</div>
                  @else
                  <div style="margin-left: auto; margin-right: auto; height: 36px; width: 36px; border-radius: 9999px; border: 1px solid #e2e8f0; background-color: #f8fafc; text-align: center; font-size: 14px; line-height: 20px; line-height: 36px; font-weight: 700; color: #94a3b8;">2</div>
                  @endif
                </td>
                <td style="width: 15%; vertical-align: middle;">
                  @if ($outActive)
                ...
                <td style="width: 10%; vertical-align: middle;">
                  ...
                  <div style="background-color: #2f4196; margin-left: auto; margin-right: auto; height: 36px; width: 36px; border-radius: 9999px; text-align: center; font-size: 14px; line-height: 20px; line-height: 36px; font-weight: 700; color: #fffffe;">✓</div>
                  @else
                  <div style="margin-left: auto; margin-right: auto; height: 36px; width: 36px; border-radius: 9999px; border: 1px solid #e2e8f0; background-color: #f8fafc; text-align: center; font-size: 14px; line-height: 20px; line-height: 36px; font-weight: 700; color: #94a3b8;">4</div>
                  @endif
                </td>
                <td style="width: 7.5%;"></td>
              </tr>
            ...
            <table cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; table-layout: fixed;">
              <tr>
                <td style="width: 25%;"><p style="color: #2f4196; margin: 8px 0 0; text-align: center; font-size: 10px; font-weight: 700; letter-spacing: .025em; text-transform: uppercase;">Placed</p></td>
                <td style="width: 25%;"><p style="margin: 8px 0 0; text-align: center; font-size: 10px; font-weight: 700; letter-spacing: .025em; color: #94a3b8; text-transform: uppercase;">Processing</p></td>
                <td style="width: 25%;"><p style="margin: 8px 0 0; text-align: center; font-size: 10px; font-weight: 700; letter-spacing: .025em; color: #94a3b8; text-transform: uppercase;">Out for delivery</p></td>
                <td style="width: 25%;"><p style="margin: 8px 0 0; text-align: center; font-size: 10px; font-weight: 700; letter-spacing: .025em; color: #94a3b8; text-transform: uppercase;">Completed</p></td>
              </tr>
            </table>
          </div>
          <!--[if mso]></td></tr></table><![endif]-->
          ...
          <div style="background-color: #fffffe; padding: 24px 36px 0;">
            <p style="margin: 0 0 8px; font-size: 11px; font-weight: 700; letter-spacing: .05em; color: #94a3b8; text-transform: uppercase;">Your order</p>
            <table cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
              <tr>
            ...
            <table cellpadding="0" cellspacing="0" role="presentation" style="margin-top: 4px; width: 100%;">
              <tr>
                <td></td>
          ...
          <div style="background-color: #fffffe; padding: 24px 36px 40px;">
            ...
            <p style="margin: 14px 0 0; font-size: 13px; color: #475569;">
              ...
              <br>
              <span style="font-weight: 700; color: #0f172a;">{{ config('app.name') }} Support Team</span>
            </p>
          </div>
          <!--[if mso]></td></tr></table><![endif]-->
