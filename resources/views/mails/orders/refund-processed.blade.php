        ...
        <div style="overflow: hidden; background-color: #fffffe;">
          ...
          <div style="background-color: #2f4196; padding: 24px 36px 32px;">
              ...
              <tr>
                <td style="padding-top: 8px; text-align: center;">
                  <div class="border-white-40" style="margin-left: auto; margin-right: auto; margin-bottom: 16px; height: 64px; width: 64px; border-radius: 9999px; border: 2px solid rgba(255, 255, 254, .4); text-align: center; line-height: 60px;">
                    <svg viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.8" style="display: inline-block; height: 28px; width: 28px; vertical-align: middle;"><path stroke-linecap="round" stroke-linejoin="round" d="M9 15 3 9m0 0 6-6M3 9h12a6 6 0 0 1 0 12h-3"></path></svg>
                  </div>
                  <h1 style="margin: 0; text-align: center; font-size: 25px; line-height: 1.25; font-weight: 800; color: #fffffe;">Refund processed</h1>
                </td>
              </tr>
            </table>
            <table cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
              <tr>
                <td style="padding-top: 24px; vertical-align: middle;">
                  ...
                  <p class="text-white-70" style="margin: 4px 0 0; font-size: 13px; color: rgba(255, 255, 254, .7);">Your refund is on its way.</p>
                </td>
            ...
            <p class="text-white-80" style="margin: 0; font-size: 13.5px; line-height: 21px; color: rgba(255, 255, 254, .8);">
              We've processed your refund. It will be credited back to your original payment method within
              <span style="font-weight: 700; color: #fffffe;">5–10 business days</span>
              .
            </p>
          </div>
          ...
          <div style="background-color: #fffffe; padding: 24px 36px 4px;">
            <p style="margin: 0 0 8px; font-size: 11px; font-weight: 700; letter-spacing: .05em; color: #94a3b8; text-transform: uppercase;">Refund details</p>
            <table cellpadding="0" cellspacing="0" role="presentation" style="width: 100%;">
              <tr>
              ...
              <tr>
                <td style="border-bottom: 1px solid; border-color: #e2e8f0; padding-top: 8px; padding-bottom: 8px; font-size: 13px; color: #64748b;">Original amount</td>
                <td style="border-bottom: 1px solid; border-color: #e2e8f0; padding-top: 8px; padding-bottom: 8px; text-align: right; font-size: 13px; font-weight: 600; color: #334155;">{{ money($order->total_cents) }}</td>
              </tr>
              <tr>
                <td style="padding-top: 8px; padding-bottom: 8px; font-size: 13px; font-weight: 600; color: #334155;">Refund amount</td>
                <td style="padding-top: 8px; padding-bottom: 8px; text-align: right; font-size: 16px; line-height: 24px; font-weight: 800; color: #059669;">{{ money($refundAmount) }}</td>
              </tr>
            </table>
            @if ($refundReason)
            <div style="margin-top: 16px; border-radius: 6px; background-color: #fffbeb; padding: 16px 20px;">
              <p style="margin: 0 0 4px; font-size: 12px; line-height: 16px; font-weight: 600; letter-spacing: .05em; color: #b45309; text-transform: uppercase;">Reason</p>
              <p style="margin: 0; font-size: 14px; line-height: 20px; color: #78350f;">{{ $refundReason }}</p>
            </div>
            @endif
          </div>
          <!--[if mso]></td></tr></table><![endif]-->
