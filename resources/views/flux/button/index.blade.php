...
$classes = Flux::classes()
    ...
    ->add(match ($size) { // Size...
        ...
        'customer' => 'h-auto text-[12px] rounded-none font-serif font-extrabold tracking-wider uppercase' . ' ' . ($square ? 'w-auto p-2' : 'px-3.5 py-1.5'),
        'customer-lg' => 'h-auto text-[13px] rounded-none font-serif font-extrabold tracking-wider uppercase' . ' ' . ($square ? 'w-auto p-2.5' : 'px-6 py-2.5'),
    })
    ...
    ->add(match ($variant) { // Background color...
        ...
        'customer-primary' => 'bg-primary hover:bg-brand-600',
    })
    ...
    ->add(match ($variant) { // Grouped border treatments...
        'ghost' => '',
        'subtle' => '',
        'outline' => '[[data-flux-button-group]_&]:border-s-0 [:is([data-flux-button-group]>&:first-child,_[data-flux-button-group]_:first-child>&)]:border-s',
        ...
        'primary' => '[[data-flux-button-group]_&]:border-e-0 [:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-e-0 dark:[:is([data-flux-button-group]>&:last-child,_[data-flux-button-group]_:last-child>&)]:border-s [:is([data-flux-button-group]>&:not(:first-child),_[data-flux-button-group]_:not(:first-child)>&)]:border-s-[color-mix(in_srgb,var(--color-accent-foreground),transparent_85%)]',
        'customer-outline' => '',
        'customer-danger' => '',
        'customer-primary' => '',
    })
