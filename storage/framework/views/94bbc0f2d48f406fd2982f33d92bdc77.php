...
<?php endif; ?>
    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between text-sm">
            <span class="text-zinc-600"><?php echo e(get_currency_symbol()); ?> <span x-text="Math.round(localMin).toLocaleString()"></span></span>
            <span class="text-zinc-600"><?php echo e(get_currency_symbol()); ?> <span x-text="Math.round(localMax).toLocaleString()"></span></span>
        </div>
        <div class="relative">
