            ...
            <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
              <tr>
                <td style="overflow: hidden; border-radius: 6px; background-color: #fffffe; border: 1px solid #e2e8f0;">
                  <div class="sm-p-6" style="display: flex; align-items: center; justify-content: space-between; background-color: #304296; padding: 12px 36px; color: #ffffff">
                    <a href="https://demo.ecommerce.sheffieldafrica.com">
                      <img src="images/logo.png" width="100" height="auto" alt="Sheffield Africa logo" style="max-width: 100%; vertical-align: middle;">
                    </a>
                    <div style="display: flex; align-items: center;">
                      ...
                      <a href="https://demo.ecommerce.sheffieldafrica.com/new-arrivals" class="hover-underline" style="padding-left: 8px; padding-right: 8px; font-size: 14px; color: #fffffe; border-right-width: 0px; border-left-width: 2px; border-color: #f8fafc;">New Arrivals</a>
                      <a href="https://demo.ecommerce.sheffieldafrica.com/account" class="hover-underline" style="padding-left: 8px; padding-right: 8px; font-size: 14px; color: #fffffe; border-right-width: 0px; border-left-width: 2px; border-color: #f8fafc;">Account</a>
                    </div>
                  </div>
                  <div class="sm-p-6" style="padding: 24px 36px">
                    ...
                    <p style="margin: 0 0 24px; font-size: 16px; line-height: 24px; color: #475569;">We are excited to have you on board! Please verify your
                      ...
                      account:</p>
                    <div>
                      <a href="https://maizzle.com" style="display: inline-block; text-decoration: none; padding: 16px 24px; font-size: 16px; line-height: 1; border-radius: 4px; background-color: #4338ca; color: #fffffe; margin-bottom: 24px;" class="hover-bg-slate-800">
                    ...
                    <p style="margin: 0; font-size: 16px; line-height: 24px; color: #475569;">
                      Thanks,
                      <br>
                      <span style="font-weight: 600;">Sheffield Africa Team</span>
                    </p>
              ...
              <tr>
                <td class="sm-px-6" style="padding: 24px 36px">
                  <p style="margin: 0; font-size: 12px; color: #64748b;">
                    &copy; 2026 Maizzle. All rights reserved.
                  </p>
                </td>
              </tr>
            </table>
...
</html><?php /**PATH C:\Users\jonah.wakahiu\Desktop\ecommerce\sheffield_ecommerce\resources\views\mails\transactional.blade.php ENDPATH**/ ?>