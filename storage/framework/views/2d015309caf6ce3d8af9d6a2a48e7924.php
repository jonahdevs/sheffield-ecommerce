            ...
            <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
              <tr>
                <td class="sm-p-6" style="border-radius: 6px; background-color: #fffffe; padding: 24px 36px; border: 1px solid #c02434">
                  ...
                  <div>
                    <a href="<?php echo e($resetUrl); ?>" style="display: inline-block; text-decoration: none; padding: 16px 24px; font-size: 16px; line-height: 1; border-radius: 4px; color: #fffffe; background-color: #304296;" class="hover-bg-secondary-hover">
                  ...
                  <p class="mso-break-all" style="margin: 0; font-size: 12px; line-height: 20px; color: #475569;">
                    ...
                    <a href="<?php echo e($resetUrl); ?>" style="color: #1e293b; text-decoration: underline;"><?php echo e($resetUrl); ?></a>
                  </p>
                </td>
              </tr>
            </table>
...
</html><?php /**PATH C:\Users\jonah.wakahiu\Desktop\ecommerce\sheffield_ecommerce\resources\views\mails\auth\password-reset.blade.php ENDPATH**/ ?>