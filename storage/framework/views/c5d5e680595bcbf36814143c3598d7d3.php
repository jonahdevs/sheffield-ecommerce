...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$product->requires_quotation && $product->type === ProductType::SIMPLE): ?>
                        <?php if (isset($__livewire)) echo $__livewire->renderIslandDirective(token: '440d17ec-1'); ?>
...
<?php endif; ?><?php /**PATH C:\Users\jonah\Herd\sheffield_ecommerce\storage\framework/views/livewire/views/cf8d6be1.blade.php ENDPATH**/ ?>