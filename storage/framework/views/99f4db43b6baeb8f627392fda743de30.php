...
new #[Title('Cash on Delivery')] class extends Component {
    ...
    public function save(PaymentSettings $settings): void
    {
        try {
            ...
            $this->dispatch('notify', variant: 'success', title: __('Settings saved'), message: __('Cash on delivery settings saved.'));
        } catch (\Throwable $e) {
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'af6a29d55d306249cfe5b80ece79872b::admin.settings.layout','data' => ['heading' => __('Cash on delivery'),'subheading' => __('Available alongside any payment mode')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Cash on delivery')),'subheading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Available alongside any payment mode'))]); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
<?php echo e(__('Cash on delivery')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::checkbox.index','data' => ['wire:model.live' => 'form.cod_enabled','label' => ''.e(__('Enable cash on delivery')).'','description' => ''.e(__('Allow customers to pay when their order is delivered')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'form.cod_enabled','label' => ''.e(__('Enable cash on delivery')).'','description' => ''.e(__('Allow customers to pay when their order is delivered')).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($form->cod_enabled): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::textarea','data' => ['label' => ''.e(__('Checkout instructions')).'','wire:model' => 'form.cod_instructions','rows' => '3','placeholder' => ''.e(__('Pay with cash when your order arrives. Our delivery agent will collect payment.')).'','description' => ''.e(__('Shown to the customer at checkout when they select this payment method')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('Checkout instructions')).'','wire:model' => 'form.cod_instructions','rows' => '3','placeholder' => ''.e(__('Pay with cash when your order arrives. Our delivery agent will collect payment.')).'','description' => ''.e(__('Shown to the customer at checkout when they select this payment method')).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\Users\jonah.wakahiu\Desktop\ecommerce\sheffield_ecommerce\resources\views\pages\admin\settings\payments\cod.blade.php ENDPATH**/ ?>