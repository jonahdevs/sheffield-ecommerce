        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-8">
            ...
            <div class="lg:col-span-1">
                <a href="/" class="inline-block mb-4">
                    <img src="<?php echo e(asset('logo-inverse.png')); ?>?v=<?php echo e(time()); ?>" alt="Company Logo"
                        class="h-12 w-auto" />
                </a>
                ...
                <div class="mb-6">
                    <div class="flex items-start gap-3 mb-2">
                        ...
                        <div>
                            <h4 class="font-semibold text-lg mb-3 text-white">Our Store Locations</h4>
                            <div class="space-y-2 text-sm text-brand-footer-text">
                                <p>01. Off Old Mombasa Road before the Nairobi SGR Terminus</p>
                                <p>02. Petrocity Complex 1st Floor-Off Links Road, Nyali, Mombasa</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-12 pt-8 border-t border-brand-footer-border">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <p class="text-sm text-brand-footer-muted">
                    © <?php echo e(date('Y')); ?> Sheffieldafrica. All Rights Reserved.
                </p>
