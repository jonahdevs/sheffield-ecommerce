...
<?php if ($as !== 'button') : ?><a <?php echo e($attributes->class($classes)); ?> data-flux-link <?php if ($external) : ?>target="_blank"<?php endif; ?>><?php echo e($slot); ?></a><?php else : ?><button <?php echo e($attributes->merge(['class' => $classes, 'type' => 'button'])); ?> data-flux-link><?php echo e($slot); ?></button><?php endif; ?><?php /**PATH C:\Users\jonah.wakahiu\Desktop\ecommerce\sheffield_ecommerce\vendor\livewire\flux\src/../stubs/resources/views/flux/link.blade.php ENDPATH**/ ?>