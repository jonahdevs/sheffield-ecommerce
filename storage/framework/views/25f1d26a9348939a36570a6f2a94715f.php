    ...
    <div class="container mx-auto px-4">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="mb-6">
                    <div class="flex items-start gap-3 mb-2">
                        ...
                        <div>
                            <h4 class="font-semibold text-lg mb-3">Our Store Locations</h4>
            ...
            <div>
                ...
                <form class="flex gap-2 flex-wrap">
                    ...
                    <input type="email" placeholder="Email address"
                        class="flex-1 px-4 py-3 bg-[#3d4f5f] border-none rounded text-sm text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-sheffield-red" />
                    <button type="submit"
                        class="px-6 py-3 bg-sheffield-red hover:bg-sheffield-red text-white rounded font-medium text-sm transition-colors">
                        Subscribe
                    </button>
                </form>
            </div>
        ...
        <div class="mt-12 pt-8 border-t border-zinc-600">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <!-- Social Media -->
                <div class="flex items-center gap-4">
                    <span class="text-sm text-zinc-400 mr-2">Follow Us:</span>
...
<!-- ====== Footer Section End -->
<?php /**PATH C:\Users\jonah\Herd\sheffield_ecommerce\resources\views\components\footer.blade.php ENDPATH**/ ?>