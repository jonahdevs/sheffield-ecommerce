...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
Card Payment <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalced986e8ff6641d3797206c3198c2b83)): ?>
<?php $attributes = $__attributesOriginalced986e8ff6641d3797206c3198c2b83; ?>
<?php unset($__attributesOriginalced986e8ff6641d3797206c3198c2b83); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.credit-card','data' => ['class' => 'size-4 text-zinc-400']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
Card Details <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                            ...
                            <div class="flex items-center gap-2.5 px-4 py-3">
                                <div class="w-10 h-10 rounded border bg-zinc-50 overflow-hidden shrink-0">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->product?->image_path): ?>
                                        <img src="<?php echo e(asset($item->product->image_path)); ?>" alt="<?php echo e($item->name); ?>"
...
<?php endif; ?>
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-medium truncate"><?php echo e($item->name); ?></p>
                    ...
                    <div class="px-4 py-3 border-t space-y-1.5">
                        ...
                        <div class="flex justify-between text-xs text-zinc-500">
                            <span>Shipping
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->order->deliveryOrder?->shippingMethod): ?>
                                    <span class="text-zinc-400">
                                        · <?php echo e($this->order->deliveryOrder->shippingMethod->name); ?>
...
<?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->order->deliveryOrder): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.truck','data' => ['class' => 'size-4 text-zinc-400']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                            ...
                            <?php echo e($this->order->shipping_address['full_name'] ?? ''); ?><br />
                            <?php echo e(implode(
                                ', ',
...
<?php endif; ?>
    ...
    ?>
<?php /**PATH C:\Users\jonah\Herd\sheffield_ecommerce\resources\views\pages\checkout\card-payment.blade.php ENDPATH**/ ?>