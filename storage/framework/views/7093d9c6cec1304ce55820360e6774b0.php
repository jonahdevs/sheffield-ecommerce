...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-2xl font-bold text-zinc-900 dark:text-white" x-data="countUp({ to: <?php echo e(Tag::count()); ?> })" x-text="display">
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-2xl font-bold text-blue-600 dark:text-blue-400" x-data="countUp({ to: <?php echo e($this->types->count()); ?> })" x-text="display">
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc4bce27d2c09d2f98a63d67977c1c3ec)): ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="text-2xl font-bold text-zinc-500 dark:text-zinc-400" x-data="countUp({ to: <?php echo e(\DB::table('taggables')->distinct('taggable_id')->count()); ?> })" x-text="display">
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc4bce27d2c09d2f98a63d67977c1c3ec)): ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                            ...
                            <div class="flex items-center gap-2">
                                <span class="inline-block w-3 h-3 rounded-full shrink-0"
                                    style="background-color: <?php echo e($tag->color ?: '#6b7280'); ?>"></span>
                                <span class="font-medium text-zinc-800 dark:text-zinc-100"><?php echo e($tag->name); ?></span>
                            </div>
                         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
