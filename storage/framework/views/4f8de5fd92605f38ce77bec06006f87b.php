                ...
                <td style="overflow: hidden; border-radius: 6px; background-color: #fffffe; border: 1px solid #e2e8f0;">
                  <div class="sm-p-6" style="display: flex; align-items: center; justify-content: space-between; background-color: #304296; padding: 16px 36px; color: #ffffff">
                    <a href="https://demo.ecommerce.sheffieldafrica.com">
                      <img src="<?php echo e(asset('images/mails/logo-inverse.png')); ?>" width="120" height="auto" alt="Sheffield Africa logo" style="max-width: 100%; vertical-align: middle;">
                    </a>
                  ...
                  <div class="sm-p-6" style="padding: 24px 36px">
                    ...
                    <p style="margin: 0 0 24px; font-size: 16px; line-height: 24px; color: #475569;">We are excited to have you on board! Please verify your
                      ...
                      account:</p>
                    <div>
                      <a href="<?php echo e($verificationUrl); ?>" style="display: inline-block; text-decoration: none; padding: 16px 24px; font-size: 16px; line-height: 1; border-radius: 4px; color: #fffffe; margin-bottom: 24px; background-color: #304296;" class="hover-bg-secondary-hover">
                    ...
                    <p class="mso-break-all" style="margin: 0; font-size: 12px; line-height: 20px; color: #475569;">
                      ...
                      your web browser:
                      <a href="<?php echo e($verificationUrl); ?>" style="color: #1e293b; text-decoration: underline;"><?php echo e($verificationUrl); ?></a>
                    </p>
                  </div>
                </td>
              </tr>
...
</html><?php /**PATH C:\Users\jonah.wakahiu\Desktop\ecommerce\sheffield_ecommerce\resources\views\mails\auth\verify-email.blade.php ENDPATH**/ ?>