...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1985457319-0', $__key);
...
?>
                ...
                <div class="flex items-center gap-3 sm:gap-4 lg:gap-6">
                    ...
                    <a href="<?php echo e(route('wishlist')); ?>" wire:navigate class="hidden lg:flex items-center gap-2">
                        <div class="relative">
...
<?php endif; ?>
                    ...
                    <a href="<?php echo e(route('products.compare')); ?>" wire:navigate class="hidden lg:flex items-center gap-2">
                        <div class="relative">
...
</div><?php /**PATH C:\Users\jonah\Herd\sheffield_ecommerce\storage\framework/views/livewire/views/0190f513.blade.php ENDPATH**/ ?>