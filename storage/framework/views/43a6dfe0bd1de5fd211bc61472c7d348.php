                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $mainPath; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div class="relative flex gap-6 <?php echo e($isLast && !$injectTerminalHere ? 'pb-0' : 'pb-10'); ?>">
                        ...
                        <div
                            ...
                            <?php echo e($reached ? 'bg-primary text-white ring-4 ring-[#fff8f6]' : 'bg-zinc-50 text-zinc-300 border border-zinc-100'); ?>">
...
<?php endif; ?>
                            ...
                            <div class="flex-1 pt-0.5">
                                <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                                    <div>
                                        <div
                                            class="text-[14px] font-bold <?php echo e($currentStatus === OrderStatus::CANCELLED ? 'text-red-600' : 'text-brand-primary'); ?>">
                                            <?php echo e($currentStatus === OrderStatus::CANCELLED ? 'Order Cancelled' : 'Order Returned'); ?>


                                            <span
                                                class="ml-2 inline-flex items-center gap-1.5 text-[10px] font-extrabold tracking-widest uppercase <?php echo e($currentStatus === OrderStatus::CANCELLED ? 'text-red-600 bg-red-50 border-red-100' : 'text-brand-primary bg-orange-50 border-orange-100'); ?> px-2 py-0.5 border rounded-sm">
                                                <span class="relative flex h-1.5 w-1.5">
                                                    <span
                                                        class="animate-ping absolute inline-flex h-full w-full rounded-full <?php echo e($currentStatus === OrderStatus::CANCELLED ? 'bg-red-600' : 'bg-brand-primary'); ?> opacity-75"></span>
                                                    <span
                                                        class="relative inline-flex rounded-full h-1.5 w-1.5 <?php echo e($currentStatus === OrderStatus::CANCELLED ? 'bg-red-600' : 'bg-brand-primary'); ?>"></span>
                                                </span>
                                                Current
                                            </span>
                                        </div>
