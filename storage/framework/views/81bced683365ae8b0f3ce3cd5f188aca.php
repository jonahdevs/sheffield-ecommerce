...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.rich-editor','data' => ['model' => 'form.short_description','value' => $this->form->short_description ?? '','placeholder' => 'Brief product summary shown in listings...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['model' => 'form.short_description','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->form->short_description ?? ''),'placeholder' => 'Brief product summary shown in listings...']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\jonah\OneDrive\Desktop\ecommerce\sheffield_ecommerce\resources\views/pages/admin/catalog/products/partials/_basic-information.blade.php ENDPATH**/ ?>