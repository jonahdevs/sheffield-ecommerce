...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.rich-editor','data' => ['model' => 'form.description','value' => $this->form->description ?? '','placeholder' => 'Describe the product features, specifications...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['model' => 'form.description','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($this->form->description ?? ''),'placeholder' => 'Describe the product features, specifications...']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\jonah\OneDrive\Desktop\ecommerce\sheffield_ecommerce\resources\views/pages/admin/catalog/products/partials/_product-description.blade.php ENDPATH**/ ?>