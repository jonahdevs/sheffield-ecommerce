                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $attribute['values']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($watchType === 'color' && $value['color_code']): ?>
                                                        <button type="button"
                                                            ...
                                                            class="relative <?php echo e($shapeClass); ?> transition-all cursor-pointer <?php echo e($isSelected ? 'ring-2 ring-offset-2 ring-secondary' : 'hover:ring-2 hover:ring-offset-2 hover:ring-zinc-300'); ?> <?php echo e($state === 'backorder' ? 'ring-amber-400' : ''); ?>"
                                                            style="<?php echo e($sizeStyle); ?>"
                                                            title="<?php echo e($value['label']); ?><?php echo e($state === 'out_of_stock' ? ' (out of stock)' : ($state === 'backorder' ? ' (backorder)' : '')); ?>">
                                                            <span
                                                                class="absolute inset-0.5 <?php echo e($shapeClass); ?> border border-zinc-200 <?php echo e($state === 'out_of_stock' ? 'opacity-50' : ''); ?>"
                                                    ...
                                                    <?php elseif($watchType === 'image' && $value['image_path']): ?>
                                                        <button type="button"
                                                            wire:click="selectAttributeValue('<?php echo e($attribute['name']); ?>', '<?php echo e($value['value']); ?>')"
                                                            class="relative <?php echo e($shapeClass); ?> border-2 transition-all cursor-pointer overflow-hidden <?php echo e($isSelected ? 'border-secondary ring-1 ring-secondary' : 'border-zinc-200 hover:border-zinc-400'); ?> <?php echo e($state === 'backorder' ? 'border-amber-400' : ''); ?>"
                                                            style="<?php echo e($sizeStyle); ?>"
                                                            title="<?php echo e($value['label']); ?><?php echo e($state === 'out_of_stock' ? ' (out of stock)' : ($state === 'backorder' ? ' (backorder)' : '')); ?>">
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            <span
                                                                class="<?php echo e($state === 'out_of_stock' ? 'line-through' : ''); ?>"><?php echo e($value['value']); ?></span>
...
<?php endif; ?>
                                    ...
                                    <div class="grid grid-cols-1 @2xl/reviews:grid-cols-4 gap-7">

                                        
                                        <div class="col-span-1">
                                            <div class="@2xl/reviews:sticky @2xl/reviews:top-44">
                                                <div
                                                    class="flex flex-col items-stretch gap-5 @md/reviews:flex-row @md/reviews:items-center @md/reviews:gap-8 @2xl/reviews:flex-col @2xl/reviews:items-stretch @2xl/reviews:gap-0">

                                                    
                                                    <div
                                                        class="text-center @md/reviews:shrink-0 @md/reviews:basis-44 @2xl/reviews:basis-auto">
                                                        <div
                                                            class="text-3xl sm:text-4xl @2xl/reviews:text-3xl font-bold text-secondary">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::separator','data' => ['class' => '@md/reviews:hidden @2xl/reviews:block @2xl/reviews:my-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => '@md/reviews:hidden @2xl/reviews:block @2xl/reviews:my-4']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                                    ...
                                                    <div
                                                        class="hidden @md/reviews:block @2xl/reviews:hidden self-stretch w-px bg-zinc-200 dark:bg-zinc-700">
                                                    </div>
                                                                ...
                                                                <div class="flex gap-0.5">
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php for($star = 1; $star <= 5; $star++): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($star <= $rating): ?>
                                                                            <?php if (isset($component)) { $__componentOriginal0bc6ca59f258b8d2577c76df279598af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0bc6ca59f258b8d2577c76df279598af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.star','data' => ['class' => 'size-4 sm:size-5 text-orange-400 fill-current']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.star'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-4 sm:size-5 text-orange-400 fill-current']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                                                        <?php else: ?>
                                                                            <?php if (isset($component)) { $__componentOriginal0bc6ca59f258b8d2577c76df279598af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal0bc6ca59f258b8d2577c76df279598af = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.star','data' => ['class' => 'size-4 sm:size-5 text-zinc-300 fill-current']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.star'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-4 sm:size-5 text-zinc-300 fill-current']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                                                                ...
                                                                <div
                                                                    class="w-full bg-zinc-200 dark:bg-zinc-700 rounded-full h-2 sm:h-2.5">
                                                                    <div class="bg-secondary h-2 sm:h-2.5 rounded-full"
                                                                        style="width: <?php echo e($data['percentage']); ?>%"></div>
                                                                </div>
                                                                <span
                                                                    class="text-xs sm:text-sm font-semibold text-secondary tabular-nums min-w-10 text-right">
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1825495708-0', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1825495708-1', $__key);
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1825495708-2', $__key);
...
</div><?php /**PATH C:\Users\jonah\Herd\sheffield_ecommerce\storage\framework/views/livewire/views/e8d4c135.blade.php ENDPATH**/ ?>