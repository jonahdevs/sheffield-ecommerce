    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title || isset($icon) || isset($action)): ?>
        <div class="flex items-center justify-between px-5 py-4 border-b border-zinc-200">
            <div
                ...
                <span><?php echo e($title); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($titleEm): ?>
                        <em class="text-primary not-italic"><?php echo e($titleEm); ?></em>
...
<?php /**PATH C:\Users\jonah.wakahiu\Desktop\ecommerce\sheffield_ecommerce\resources\views/components/customer/card.blade.php ENDPATH**/ ?>