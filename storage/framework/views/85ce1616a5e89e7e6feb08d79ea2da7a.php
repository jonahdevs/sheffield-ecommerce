...
new #[Title('PesaWise Settings')] class extends Component {
    ...
    public function save(PesawiseSettings $settings): void
    {
        try {
            ...
            $this->dispatch('notify', variant: 'success', title: __('Settings saved'), message: __('PesaWise settings saved.'));
        } catch (\Throwable $e) {
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'af6a29d55d306249cfe5b80ece79872b::admin.settings.layout','data' => ['heading' => __('PesaWise'),'subheading' => __('Configure PesaWise — handles M-Pesa, Airtel, cards and bank payments')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('PesaWise')),'subheading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Configure PesaWise — handles M-Pesa, Airtel, cards and bank payments'))]); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
<?php echo e(__('PesaWise status')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'af6a29d55d306249cfe5b80ece79872b::admin.settings.payments.partials.encrypted-field','data' => ['label' => ''.e(__('API key')).'','model' => 'form.api_key','hasValue' => $form->has_api_key]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('API key')).'','model' => 'form.api_key','hasValue' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($form->has_api_key)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginal496a7d4d7bdefaaed692fb2cb0ac47b7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal496a7d4d7bdefaaed692fb2cb0ac47b7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'af6a29d55d306249cfe5b80ece79872b::admin.settings.payments.partials.encrypted-field','data' => ['label' => ''.e(__('API secret')).'','model' => 'form.api_secret','hasValue' => $form->has_api_secret]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('pages::admin.settings.payments.partials.encrypted-field'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('API secret')).'','model' => 'form.api_secret','hasValue' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($form->has_api_secret)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['label' => ''.e(__('Merchant account number')).'','wire:model' => 'form.account_number','placeholder' => ''.e(__('Your PesaWise merchant account number')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('Merchant account number')).'','wire:model' => 'form.account_number','placeholder' => ''.e(__('Your PesaWise merchant account number')).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <div class="p-5">
                        <?php if (isset($component)) { $__componentOriginal26c546557cdc09040c8dd00b2090afd0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal26c546557cdc09040c8dd00b2090afd0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['label' => ''.e(__('Callback URL')).'','wire:model' => 'form.callback_url','placeholder' => ''.e(url('/api/pesawise/callback')).'','description' => ''.e(__('Register this URL in your PesaWise dashboard.')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('Callback URL')).'','wire:model' => 'form.callback_url','placeholder' => ''.e(url('/api/pesawise/callback')).'','description' => ''.e(__('Register this URL in your PesaWise dashboard.')).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH C:\Users\jonah.wakahiu\Desktop\ecommerce\sheffield_ecommerce\resources\views\pages\admin\settings\payments\pesawise.blade.php ENDPATH**/ ?>