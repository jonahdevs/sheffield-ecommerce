...
<head>
    ...
    <title><?php echo e(__('Payment Confirmation')); ?> - <?php echo e(config('app.name', 'Laravel')); ?></title>
...
<body class="font-sans text-gray-600 bg-gray-100 leading-normal p-4 h-full">
    <div id="app" class="h-full md:flex md:justify-center md:items-center">
        <div class="w-full max-w-lg">
            <h1 class="text-4xl font-bold text-center p-4 sm:p-6 mt-4">
                Your <?php echo e($amount); ?> payment
            </h1>
            ...
            <div class="bg-white rounded-lg shadow-xl p-4 sm:p-6 mt-4">
                ...
                <div v-else>
                    ...
                    >
                        ...
                        <span v-else>
                            Confirm your <?php echo e($amount); ?> payment with {{ paymentMethodTitle }}
                        </span>
                    </button>
                </div>

                <button @click="goBack" ref="goBackButton" data-redirect="<?php echo e($redirect); ?>"
    ...
    <script>
        window.stripe = Stripe('<?php echo e($stripeKey); ?>');
        ...
        new Vue({
            ...
            data() {
                return {
                    paymentIntent: <?php echo json_encode($paymentIntent, 15, 512) ?>,
                    paymentMethod: null,
                    name: '<?php echo e(optional($customer)->stripeName()); ?>',
                    email: '<?php echo e(optional($customer)->stripeEmail()); ?>',
                    paymentElement: null,
                    remember: false,
                    isPaymentProcessing: false,
                    errorMessage: '<?php echo e($errorMessage); ?>'
                }
            },
            ...
            methods: {
                configurePayment: function (paymentIntent) {
                    ...
                    if (this.paymentMethod === null || ! paymentMethodTypes.includes(this.paymentMethod.type)) {
                        const type = this.paymentMethod === null
                            ? ('<?php echo e($paymentMethod); ?>' ? '<?php echo e($paymentMethod); ?>' : paymentMethodTypes[0])
                ...
                confirmPaymentMethod: function () {
                    ...
                    if (this.paymentMethod.redirects) {
                        data.return_url = '<?php echo e(route('cashier.payment', $paymentIntent['id']).'?redirect='.$redirect); ?>';
                    }
                ...
                confirmCallback: function (result) {
                    ...
                    if (result.error) {
                        if (result.error.code === '<?php echo e(Stripe\ErrorObject::CODE_PARAMETER_INVALID_EMPTY); ?>') {
...
<?php /**PATH C:\Users\jonah.wakahiu\Desktop\ecommerce\sheffield_ecommerce\vendor\laravel\cashier\resources\views\payment.blade.php ENDPATH**/ ?>